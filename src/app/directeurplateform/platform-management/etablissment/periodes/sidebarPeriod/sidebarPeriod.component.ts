...
@Component({
  selector: "app-sidebarPeriod",
  templateUrl: "./sidebarPeriod.component.html",
  styleUrls: ["./sidebarPeriod.component.css",    "../../../../../../assets/scss/ng-select/ng-select.scss",
]
})
export class SidebarPeriodComponent implements OnInit {
